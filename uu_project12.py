...
if st.button('Run Backtest'):
    ...
    df_pos['Amount'] = df_pos['Quantity'] * df_pos['Close'].cumsum()
    ...
    df_pos['Net Amount'] = df_pos['Quantity'] * df_pos['Close'].cumsum()
    df_pos['Cumulative Returns'] = (((df_pos['Net Amount'].cumsum() / principal) - 1) * 100).cumsum()
